  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden pb-24 bg-bg-light">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-lg border-t border-neutral-100 p-4 safe-bottom shadow-[0_-4px_20px_rgba(0,0,0,0.02)]">
        <button 
            onClick={() => navigate('/cart')}
            className="relative w-full overflow-hidden rounded-xl bg-primary h-14 group transition-transform active:scale-[0.99] shadow-lg shadow-primary/30"
        >
            <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out"></div>
            <div className="relative flex items-center justify-between px-6 h-full">
                <span className="text-sm font-bold text-[#112114]">1 Item</span>
                <span className="text-base font-bold text-[#112114] uppercase tracking-wide">Add to Cart</span>
                <span className="text-sm font-bold text-[#112114]">$68.00</span>
            </div>
        </button>
      </div>
    </div>
